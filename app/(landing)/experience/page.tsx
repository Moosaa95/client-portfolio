          ...
          <div className="mx-auto max-w-5xl">
            <Tabs defaultValue="professional" className="w-full">
              ...
              <ExperienceCard
                ...
                description="Co-lead PayRep (licensed PSSP super-agent & microfinance bank), driving high-volume payments, collections, and access to health insurance, pension savings and micro-credit for traders, SMEs and farmers in Northern Nigeria."
              ...
              <ExperienceCard
                ...
                description="Advise entrepreneurs and growth-stage businesses on regulatory licensing, fundraising deal sourcing, strategic partnerships, and capacity-building for team cohesion."
              ...
              <ExperienceCard
                ...
                period="Oct 2024 - Present"
                description="Oversee strategic management and execution as part of the FintechNGR executive governing council."
              ...
              <ExperienceCard
                ...
                description="Guide global expansion and product strategy for a borderless payments platform offering gateways, card issuing, and business accounts."
              ...
              <ExperienceCard
                ...
                description="Provide board-level secretarial, compliance and regulatory affairs guidance to one of Nigeria’s largest local-rice producers."
                icon={<Users className="h-6 w-6" />}
              />
              <ExperienceCard
                title="Advisor & Company Secretary"
                company="Extension Africa"
                period="Oct 2024 - Present"
                description="Deliver legal advisory and secretarial services for FAMEX, empowering thousands of farmers with extension services and financial inclusion."
                icon={<Briefcase className="h-6 w-6" />}
              />
              <ExperienceCard
                title="Mentor"
                ...
                description="Coach researchers and innovators through the UK-RISA funded Innovation to Market program to scale their ideas into viable businesses."
                icon={<UserCheck className="h-6 w-6" />}
              />
              <ExperienceCard
                title="Member"
                company="FinTech Connector"
                period="Oct 2024 - Present"
                description="Support the global fintech community by facilitating introductions, knowledge-sharing, and collaboration across remote networks."
                icon={<Briefcase className="h-6 w-6" />}
              />
              <ExperienceCard
                title="Co-Founder & Chief Commercial Officer"
                company="XCHANGEBOX"
                period="Jul 2019 - Mar 2024"
                description="Scaled PayRep’s network across Northern Nigeria, managing regulatory affairs, deal funnels, and partnerships to drive payments and collections growth."
                icon={<Building className="h-6 w-6" />}
              />
              <ExperienceCard
                title="Head, Strategy Development"
                company="Digital Bridge Institute"
                period="Mar 2017 - Feb 2024"
                description="Shaped strategic partnerships, policy frameworks and stakeholder engagement to build digital-economy capacity through targeted training."
                icon={<BookOpen className="h-6 w-6" />}
              />
              <ExperienceCard
                title="Placement Lead, DigiGirls"
                company="CyberSafe Foundation"
                period="Nov 2021 - Feb 2023"
                description="Led internship placement for 2,000 graduates of a 4,000-girl digital skills program, securing partnerships with corporate and international organizations."
                icon={<Briefcase className="h-6 w-6" />}
              />
              <ExperienceCard
                title="Co-Chair, Legal & Digital Rights"
                company="Internet Society (Nigeria)"
                period="Jun 2021 - Feb 2023"
                description="Co-led policy framing and advocacy for open internet access and digital rights balancing responsible use and societal growth."
                icon={<Scale className="h-6 w-6" />}
              />
              <ExperienceCard
                title="Service Consultant"
                company="Accelerated Service Incubator Lab (ASIN5)"
                period="Aug 2020 - Feb 2021"
                description="Validated product ideas with clients, gathered feedback, and collaborated on efficient product delivery in fintech service development."
                icon={<Briefcase className="h-6 w-6" />}
              />
              <ExperienceCard
                title="Administrative Officer I, Legal"
                company="Osun State University"
                period="Jun 2014 - Feb 2017"
                description="Drafted and reviewed university policies and agreements, and managed council mediation for legal and staff conflict resolution."
                icon={<BookOpen className="h-6 w-6" />}
              />
              <ExperienceCard
                title="Associate, Legal & Compliance"
                company="Teasy Mobile International"
                period="Jun 2012 - Jun 2014"
                description="Coordinated mobile-money licensing, designed SLA benchmarks, and advised on AML/compliance frameworks to reduce fraud risks."
                icon={<Scale className="h-6 w-6" />}
              />
              <ExperienceCard
                title="Associate"
                company="Odujinrin & Adefulu"
                period="Jan 2012 - May 2012"
                description="Conducted due diligence for syndicated funding, managed NIPC and NOTAP registrations, and provided general legal advisory."
                icon={<Briefcase className="h-6 w-6" />}
              />
              <ExperienceCard
                title="NYSC Intern"
                ...
                description="Supported drafting of telecom partnership agreements, debenture deeds, and corporate filings with the CAC."
                icon={<Briefcase className="h-6 w-6" />}
              />
      ...
      <section className="w-full py-16 md:py-24">
        <div className="container px-4 md:px-6">
          ...
          <div className="grid gap-8 md:grid-cols-3">
            <TestimonialCard
              quote="Abiola's expertise in regulatory compliance was instrumental in helping us secure our fintech license in record time. His guidance throughout the process was invaluable."
              name="Aisha Mohammed"
              title="CEO, PayTech Solutions"
              image="/placeholder.svg?height=100&width=100"
            />
            <TestimonialCard
              quote="Working with Abiola transformed our business model. His strategic insights and industry connections helped us pivot and scale in ways we hadn't imagined possible."
              name="Michael Okonkwo"
              title="Founder, CreditLink"
              image="/placeholder.svg?height=100&width=100"
            />
            <TestimonialCard
              quote="Abiola's deep understanding of both legal and business aspects of fintech made him the perfect advisor for our startup. He helped us navigate complex regulations while focusing on growth."
              name="Sarah Chen"
