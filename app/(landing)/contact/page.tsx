              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">+234 813 708 3075</p>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">info@abiolajimoh.com</p>
              ...
              <div className="relative overflow-hidden rounded-2xl bg-muted/30 p-8">
                ...
                <div className="relative space-y-4">
                  ...
                  <Button className="rounded-full" asChild>
                    <Link href="https://calendly.com/abiolajohnson/consultation">
