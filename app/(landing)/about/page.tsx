        ...
        <div className="container px-4 md:px-6">
          ...
          <div className="mx-auto max-w-4xl space-y-8">
            <TimelineItem
              ...
              title="B.L Law"
              organization="Nigerian Law School"
              period="2009 - 2010"
              description="Nigerian Law Society Professional Examinations"
            />

            <TimelineItem
              icon={<GraduationCap className="h-5 w-5" />}
              title="Bachelor of Laws (LLB), Banking, Corporate, Finance and Securities"
              organization="Obafemi Awolowo University"
              period="2003 - 2009"
              description="specialization in corporate and commercial law."
            />
